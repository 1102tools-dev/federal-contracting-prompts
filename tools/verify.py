...
for link in page.links:
 ...
 if link.startswith('https://'):assert link.startswith(('https://github.com/1102tools-dev/federal-contracting-prompts','https://github.com/1102tools-dev/federal-contracting-mcps')),link
